...
articleView.create = function() {
  ...
  rawData.saveEntry = function (event) {
    event.preventDefault();
    rawData.data.push(rawData.newEntry);
  ...
  rawData.init = function () {
    rawData.newEntry = new Article({});
    rawData.data.forEach(function (entry) {
